...
//void add_victim_html__Valid_input__Victim_is_added()
//{
//	HTMLRepository repository{ "C:\\Users\\Tudor\\Desktop\\D\\faculta\\SemII\\OOP\\Laboratories\\Asignment8\\Asignment8\\tests.html" };
//
//	Victim victim{ "aa","bb",2,"cc" };
//
//	repository.add_victim(victim);
//
//	std::vector<Victim> v = repository.get_victims();
//	for (Victim victimm : v)
//		cout << victimm;
//}
//
//void test_html_repository()
//{
//	add_victim_html__Valid_input__Victim_is_added();
//}
